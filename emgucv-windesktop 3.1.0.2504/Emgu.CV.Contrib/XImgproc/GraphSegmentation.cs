...
namespace Emgu.CV.Ximgproc
{
   ...
   public static partial class XimgprocInvoke
   {
      ...
      internal static extern IntPtr cveGraphSegmentationCreate(double sigma, float k, int minSize);

      [DllImport(CvInvoke.ExternLibrary, CallingConvention = CvInvoke.CvCallingConvention)]
      internal static extern void cveGraphSegmentationProcessImage(IntPtr segmentation, IntPtr src, IntPtr dst);

      [DllImport(CvInvoke.ExternLibrary, CallingConvention = CvInvoke.CvCallingConvention)]
      internal static extern void cveGraphSegmentationRelease(ref IntPtr segmentation);
   }
}
